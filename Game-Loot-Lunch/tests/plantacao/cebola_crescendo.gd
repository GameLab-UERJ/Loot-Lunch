...
const cena_cebola = preload("res://tests/plantacao/cebola.tscn") 
...
func _tentar_dropar_cebolas() -> void:
	var quantidade_atual_no_chao = _contar_cebolas_perto()
